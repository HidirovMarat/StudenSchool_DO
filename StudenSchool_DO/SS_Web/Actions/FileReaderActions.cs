...
public class FileReaderActions : IFileReaderActions
{
    ...
    private CreateFileReaderResponse _createFileReaderResponse;

    public FileReaderActions(FileReader fileReader, CreateFileReaderResponse createFileReaderResponse)
    {
